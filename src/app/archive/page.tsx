...
/**
 * Brief §8: Archive list links to /archive/[slug] routes for shareable URLs.
 * Brief §7: Keep six experiments — no random additions.
 */
            ...
            {EXPERIMENTS.map((exp) => (
              ...
              >
                ...
                <div className="col-span-12 md:col-span-5">
                  ...
                  <p className="font-mono text-[10px] tracking-[0.08em] text-amber/80 mt-3">
                    {exp.formula}
                  </p>
                </div>
                <div className="col-span-12 md:col-span-3 flex flex-col gap-1 md:items-end">
                  ...
                  <span className="font-mono text-[10px] tracking-[0.15em] uppercase text-amber mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    OPEN →
                  </span>
                </div>
              </Link>
